      ...
      <section className="bg-white py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="max-w-3xl mb-16">
            <div className="inline-flex items-center gap-1.5 text-xs font-mono font-bold uppercase text-dnc-blue tracking-widest bg-blue-50/80 px-3.5 py-1.5 rounded-xl border border-blue-100/50 mb-3.5">
          ...
          <div className="mt-12">
            <div className="flex items-center gap-2 mb-8 pb-3 border-b border-slate-100">
              <span className="w-2.5 h-2.5 rounded-full bg-[#eb0000] animate-ping" />
              <h3 className="text-xs font-mono font-bold uppercase tracking-wider text-slate-400">
                Three Core Action Pillars Under Deliberation
              </h3>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-3xl p-8 hover:bg-white hover:border-dnc-blue/30 hover:shadow-lg transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
                ...
                <div>
                  ...
                  <span className="text-[10px] uppercase font-bold text-slate-400 font-mono tracking-widest block mb-1">Pillar One</span>
                  ...
                  <ul className="space-y-3">
                    <li className="flex gap-2.5 items-start text-xs text-slate-600 font-sans leading-relaxed">
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex items-center justify-between text-[10px] font-mono text-slate-400">
                  <span>Track Room A (Monal)</span>
                  <span className="inline-flex items-center gap-1 text-dnc-blue font-bold group-hover:translate-x-1 transition-transform">
                    Explore Plenary <ChevronRight className="w-3 h-3" />
                  </span>
                </div>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-3xl p-8 hover:bg-white hover:border-dnc-orange/30 hover:shadow-lg transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
                ...
                <div>
                  ...
                  <span className="text-[10px] uppercase font-bold text-slate-400 font-mono tracking-widest block mb-1">Pillar Two</span>
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex items-center justify-between text-[10px] font-mono text-slate-400">
                  <span>Plenary Hall / Hall B</span>
                  <span className="inline-flex items-center gap-1 text-[#eb0000] font-bold group-hover:translate-x-1 transition-transform">
                    Explore Plenary <ChevronRight className="w-3 h-3" />
                  </span>
                </div>
              </div>
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-3xl p-8 hover:bg-white hover:border-dnc-orange/30 hover:shadow-lg transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
                ...
                <div>
                  ...
                  <span className="text-[10px] uppercase font-bold text-slate-400 font-mono tracking-widest block mb-1">Pillar Three</span>
                ...
                <div className="mt-8 pt-4 border-t border-slate-100 flex items-center justify-between text-[10px] font-mono text-slate-400">
                  <span>Track Room B (Lophophorus)</span>
                  <span className="inline-flex items-center gap-1 text-dnc-orange font-bold group-hover:translate-x-1 transition-transform">
                    Explore Plenary <ChevronRight className="w-3 h-3" />
                  </span>
                </div>
              </div>
      ...
      <section className="relative bg-gradient-to-b from-[#0d0f2b] to-[#111332] py-24 text-white overflow-hidden border-t border-white/[0.04]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-mono font-bold uppercase tracking-widest text-[#eb0000] mb-3">
              <Calendar className="w-3.5 h-3.5" />
              Chrono & Location Anchors
            </div>
            <h2 className="font-display font-black text-3xl sm:text-4xl text-white tracking-tight">
              Summit Agenda Schedule & Corporate Hub
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch">
            ...
            <div className="bg-white/[0.02] backdrop-blur-md rounded-3xl border border-white/10 p-8 sm:p-10 hover:border-white/20 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center justify-between pb-6 border-b border-white/[0.08] mb-8">
                  <div className="inline-flex items-center gap-2 text-xs font-bold text-[#eb0000] font-mono uppercase tracking-widest">
                    <Clock className="w-4 h-4 text-dnc-orange" />
                    Chrono Ticket
                  </div>
                  <span className="text-[10px] font-mono text-slate-400 bg-white/5 px-2.5 py-1 rounded-md">STATUS: FINALIZED</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                  ...
                  <div className="bg-white rounded-2xl border border-white/20 shadow-xl flex flex-col overflow-hidden shrink-0 w-28 text-slate-900 mx-auto sm:mx-0">
                    <div className="bg-[#eb0000] text-white text-[10px] font-mono font-bold text-center py-2 uppercase tracking-wider">
                      JULY 2026
                    </div>
                    <div className="flex flex-col items-center justify-center py-4 bg-white select-none">
                      ...
                      <span className="text-[8.5px] font-mono font-bold text-dnc-blue mt-1 uppercase tracking-widest">FRIDAY</span>
                    </div>
                    <div className="border-t border-dashed border-slate-200 bg-slate-50 py-1.5 text-center text-[7.5px] font-mono font-bold text-slate-500">
                      ASAR 19, 2083 BS
                    </div>
                  </div>
              ...
              <div className="mt-10 pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-[10px] font-mono text-slate-400">★ Integrates with Outlook, Apple & Google accounts</span>
                <button
                  onClick={handleAddToCalendar}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 bg-[#eb0000] hover:bg-[#c20000] text-white text-[10.5px] font-bold font-mono uppercase tracking-wider rounded-xl transition-all duration-300 shadow-md cursor-pointer"
                >
            ...
            <div className="bg-white/[0.02] backdrop-blur-md rounded-3xl border border-white/10 p-8 sm:p-10 hover:border-white/20 transition-all duration-300 flex flex-col justify-between group relative overflow-hidden">
              ...
              <div>
                <div className="flex items-center justify-between pb-6 border-b border-white/[0.08] mb-8">
                  <div className="inline-flex items-center gap-2 text-xs font-bold text-dnc-blue-light font-mono uppercase tracking-widest">
                    <Compass className="w-4 h-4" />
                    Coordinate Hub
                  </div>
                  <span className="text-[10px] font-mono text-dnc-orange bg-dnc-orange/5 px-2.5 py-1 rounded-md border border-dnc-orange/10">LALITPUR VALLEY</span>
                </div>

                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                  
                  {/* Schematic Compass Panel */}
                  <div className="bg-slate-950 rounded-2xl border border-white/10 flex flex-col items-center justify-center p-4 text-center shrink-0 w-28 h-28 mx-auto sm:mx-0 shadow-xl relative overflow-hidden">
                    ...
                    <span className="text-[7px] font-mono uppercase text-slate-500 mt-2 block tracking-wider">GEODETICS</span>
                    <span className="text-[9px] font-mono text-dnc-orange-light font-bold leading-none mt-0.5">27.6756° N</span>
                    <span className="text-[9px] font-mono text-dnc-orange-light font-bold leading-none mt-0.5">85.3151° E</span>
                  </div>
              ...
              {/* Action sync */}
              <div className="mt-10 pt-6 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-[10px] font-mono text-slate-400">★ Full valet and charging stations available</span>
                <button
                  onClick={handleOpenMap}
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 bg-white hover:bg-slate-100 text-slate-800 text-[10.5px] font-bold font-mono uppercase tracking-wider rounded-xl transition-all duration-300 shadow-md cursor-pointer"
                >
          ...
          <div className="mt-10 bg-white/[0.01] border border-white/5 rounded-2xl p-4 flex items-center justify-center gap-2.5 text-[10.5px] font-mono text-slate-450 text-center">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span>Interactive systems connected. Out-of-valley delegates please consult the travel helpdesk during checkout.</span>
          </div>
